...
<div x-data="{ activeModal: null }" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
  ...
  <div
    ...
    <div class="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity" @click="activeModal = null"></div> <!-- Modal Shade -->
        ...
        <div class="inline-block w-full p-6 align-bottom bg-gray-800 dark:bg-gray-900 rounded-2xl text-left overflow shadow-xl transform transition-all sm:max-w-4xl 2xl:max-w-6xl 2xl:h-6/6"> <!-- Modal Body -->
