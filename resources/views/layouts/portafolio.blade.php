    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
      ...
      <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
          <li>
            <a href="/" class="block py-2 pr-4 pl-3 text-gray-700 dark:text-white hover:text-indigo-500 lg:p-0 transition">About</a>
          </li>
          <li>
            <a href="resume" class="block py-2 pr-4 pl-3 text-gray-700 dark:text-white hover:text-indigo-500 lg:p-0 transition">Resume</a>
          </li>
          <li>
            <a href="portafolio" class="block py-2 pr-4 pl-3 text-gray-700 dark:text-white hover:text-indigo-500 lg:p-0 transition">Portfolio</a>
          </li>
          <li>
            <a href="contacto" class="block py-2 pr-4 pl-3 text-gray-700 dark:text-white hover:text-indigo-500 lg:p-0 transition">Contact</a>
          </li>
        </ul>
      </div>
    </div>
