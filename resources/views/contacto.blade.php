...
<article class="contact px-4 max-w-4xl mx-auto bg-black bg-opacity-40 shadow-md rounded-lg" data-page="contact">
  ...
  <section class="contact-form bg-gray-900 p-6 rounded-lg shadow-md">
    <h3 class="text-2xl font-semibold mb-6 text-White text-center">Contact Form</h3>

    <form id="contactForm" class="space-y-5" data-form autocomplete="off" aria-label="Formulario de contacto">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
          <label for="fullname" class="block text-sm font-medium text-gray-300 mb-1">Name</label>
          <input
            type="text"
            id="fullname"
            name="fullname"
...
<script>
    document.getElementById("contactForm").addEventListener("submit", function (event) {
        ...
        const whatsappMessage = `*Message from portfolio*\n\n*Name:* ${fullname}\n*Email:* ${email}\n*Message:* ${message}`;
